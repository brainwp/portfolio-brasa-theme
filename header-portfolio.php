    ...
    <div id="menu-brasa">
        <ul>
            ...
            if (strpos($wpurl,'cultura') !== false) {
             ...
             ?>
            <li class="menu-web<?php echo $classe_web; ?>"><a href="http://www.web.brasa.art.br">Web</a></li>
			<li class="menu-design<?php echo $classe_design; ?>"><a href="http://www.design.brasa.art.br">Design</a></li>
            <li class="menu-cultura<?php echo $classe_cultura; ?>"><a href="http://www.cultura.brasa.art.br">Cultura</a></li>
        </ul>
    </div><!-- #menu-brasa -->
