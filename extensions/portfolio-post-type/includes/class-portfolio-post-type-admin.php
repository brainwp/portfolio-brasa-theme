		...
		<?php } else {
	    	...
	    	<style>
				#menu-posts-<?php echo $this->registration_handler->post_type; ?> .wp-menu-image {
					background: url(<?php echo get_stylesheet_directory_uri(); ?>/extensions/portfolio-post-type/images/portfolio-icon.png) no-repeat 6px 6px !important;
				}
				...
				#icon-edit.icon32-posts-<?php echo $this->registration_handler->post_type; ?> {
					background: url(<?php echo get_stylesheet_directory_uri(); ?>/extensions/portfolio-post-type/images/portfolio-32x32.png) no-repeat;
				}
